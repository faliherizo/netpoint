...
<c:url var="urlRecherche" value="/renouvellementDuMois"/>
<div id="page">
<h2><spring:message code="label.renouvmois"/> </h2>
  <div class="scrollauto">
	 ...
	 <div class="resultat" >
		...
		<display:table name="${listcommand}" requestURI="renouvellementDuMois"
