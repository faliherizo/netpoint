...
<%
	...
	Enumeration<String> requestAttributeNames =(Enumeration<String>)request.getAttributeNames();
    for (String attribute : Collections.list(requestAttributeNames)) {
...
<table border="1">
	...
	<%
		@SuppressWarnings("unchecked")
		Enumeration<String> sessionAttributeNames =(Enumeration<String>)session.getAttributeNames();
	    for (String attribute : Collections.list(sessionAttributeNames)) {
...
<table border="1">
	...
	<%
		@SuppressWarnings("unchecked")
		Enumeration<String> applicationAttributeNames =(Enumeration<String>)application.getAttributeNames();
		for (String attribute : Collections.list(applicationAttributeNames)) {
	        String value;
...
<table border="1">
	...
	<%
		@SuppressWarnings("unchecked")
		Enumeration<String> applicationInitParameterNames = (Enumeration<String>)application.getInitParameterNames();
	    for (String parameter : Collections.list(applicationInitParameterNames)) {
