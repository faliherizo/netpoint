...
public class ReportRenderer  {
	...
	protected void processReportDesignDocAndRenderReport(HttpServletRequest request,
		...
		String downloadFileName = reportName+"_"+day+"_"+month+"_"+year;
		...
		runnable = birtEngine.openReportDesign( sc.getRealPath("WEB-INF/birt")+"/"+reportName+".rptdesign");
		...
		//if XLS set XLS related downloading options 
			...
			HTMLRenderOption xlsOptions = new HTMLRenderOption();
